  ...
  return (
    <footer className="bg-gray-100 dark:bg-slate-900 py-8">
      <div className="mx-auto w-11/12">
        ...
        <div className="mb-6">
          <Logo />
          <p className="mt-4 w-xl text-gray-600 dark:text-slate-400">
        ...
        <div className="mb-6 text-center">
          <a
            href="/about"
            className="mx-4 text-blue-500 dark:text-blue-400 hover:underline"
          >
            About Us
          </a>
          <a
        ...
        <div className="mb-6 text-center">
          <a
            ...
            className="mx-2 inline-block text-gray-600 dark:text-slate-400 hover:text-blue-500 dark:hover:text-blue-400"
          >
            <FaFacebook size={24} />
          </a>
          <a
